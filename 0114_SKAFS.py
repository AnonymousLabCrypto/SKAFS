...
if G_sigma_2==Hash(CA_Sync_K_G_CA_previous,Gateway_Identity,G_nonce):
    ...
    D_sync_CA_G=0
    print("CA_Sync_K_G_CA:",CA_Sync_K_G_CA)
    print("Gateway_Identity:",Gateway_Identity)
    print("G_nonce:",G_nonce)
...
print("IoT_K_i_obfuscated^G_K_previous=",IoT_K_i_obfuscated^G_K_previous)
print("IoT_K_i_obfuscated^G_K_before_previous=",IoT_K_i_obfuscated^G_K_before_previous)
print("G_K_current=",G_K_current)
